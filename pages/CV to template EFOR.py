...
if data_file:
    ...
    # 4) render and save
    tpl.render(context)
    output_file_name = f"EFOR TEMPLATE FILLED {context["first_name"]}_{context["last_name"]}_{context["job_position"].replace("/",'')}.docx"
    tpl.save(output_file_name)
...
if context is not None:
    ...
    st.download_button(
        ...
        data=Path(f"output_documents/"+output_file_name).read_bytes(),
